...
import landscaleImage from 'terraso-web-client/assets/tools/landscale-screenshot.png';
import storyMapsImage from 'terraso-web-client/assets/tools/story-maps.png';
