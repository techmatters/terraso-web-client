...
import BaseDropZone from 'terraso-web-client/common/components/DropZone';
import { fileWrapper } from 'terraso-web-client/common/fileUtils';
import FormField from 'terraso-web-client/forms/components/FormField';
