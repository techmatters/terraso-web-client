...
export const JEST_TEST_TIMEOUT = process.env.REACT_APP_JEST_TEST_TIMEOUT || 15000;

export const AXE_TEST_TIMEOUT = process.env.REACT_APP_AXE_TEST_TIMEOUT || 20000;

export const GEOJSON_MAX_SIZE = process.env.REACT_APP_GEOJSON_MAX_SIZE || 1000000; // 10 MB
